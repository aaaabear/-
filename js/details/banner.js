(function(w){
    w.banner = function(){
        ...
        lock = false;
        bgColor = ["rgb(195, 195, 136)","rgb(194, 174, 196)","rgb(218, 155, 161)","rgb(196, 164, 165)"]; //背景色
        var mySwiper = new Swiper('.swiper-container',{
            ...
            on:{
                transitionStart: function(){
                    ...
                    this.slides.eq(this.previousIndex).find('h3').transition(1000).css('color','rgba(224,208,61,0)');//文字透明动画
                ...
                transitionEnd: function(){
                    ...
                    this.slides.eq(this.activeIndex).find('h3').transition(1000).css('color','rgba(224,208,61,1)');
